...
echo STOPPING VOWELCONSCOUNTER
taskkill /FI "WINDOWTITLE eq %VOWELCONSCOUNTER_PROCESS_TITLE%"

echo STOPPING VOWELCONSRATER
taskkill /FI "WINDOWTITLE eq %VOWELCONSRATER_PROCESS_TITLE%"
